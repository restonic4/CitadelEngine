...
public class KeyBinds extends AbstractRegistryInitializer {
    ...
    public void register() {
        NONE = Registry.register(Registries.KEY_BIND, new AssetLocation(CitadelConstants.REGISTRY_NAMESPACE, "none"), new KeyBind());
        ...
        RENAME = Registry.register(Registries.KEY_BIND, new AssetLocation(CitadelConstants.REGISTRY_NAMESPACE, "rename"), new KeyBind(GLFW.GLFW_KEY_F2));
